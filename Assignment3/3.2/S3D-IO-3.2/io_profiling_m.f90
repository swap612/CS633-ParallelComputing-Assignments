...
!
 ...
 1001     FORMAT('    ',A32,' = ',A)
      ...
      subroutine set_io_hints(flag)
          ...
          call MPI_Info_set(file_info, 'romio_ds_write',    'enable', err)
          call MPI_Info_set(file_info, 'romio_ds_read',     'enable', err)
          ...
          call MPI_Info_set(file_info, 'cb_config_list','*:2',err )  
          call MPI_Info_set(file_info, 'cb_buffer_size','26214400',err)
      ...
      subroutine  print_io_performance(io_time)
          ...
          use param_m,    only : nx_g, ny_g, nz_g, nsc
 ...
 2005         FORMAT(A, i7,' x',i7,' x',i7)
              ...
              write(6, 2005) ' Number of species   :  ',nsc  
          endif
